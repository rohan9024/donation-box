...
function donate() {
  ...
  return (
    <div className=' bg-gray-900 text-gray-200 pb-20'>
      <div className="h-[400px] w-screen bg-purple-600 flex justify-center items-center">
        <h1 className='text-5xl'>"Charity brings to life again those who are spiritually dead"</h1>
      </div>
      ...
      <div className='grid grid-cols-3 gap-4 ml-20 mr-20 mt-20 '>
        ...
        {donationTypes.map((type) => (
          <div key={type.id} className='flex flex-col justify-center items-center hover:border-4 hover:border-blue-600 hover:ease-in-out hover:rounded-lg hover:cursor-pointer'>
